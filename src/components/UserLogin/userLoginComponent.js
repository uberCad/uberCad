        ...
        <Form>
          <Row>
            <Col smOffset={4} sm={6}>
              ...
              <Col sm={3}>
                <a href={'https://accounts.google.com/o/oauth2/auth?response_type=code&access_type=offline&scope=email&client_id=' + process.env.REACT_APP_GOOGLE_CLIENT_ID + '&redirect_uri=' + encodeURI(process.env.REACT_APP_GOOGLE_REDIRECT_URL)}>
                  <span className='fa fa-google' /> Google</a>
              </Col>
              <Col sm={3}>
                <a href={'https://www.facebook.com/dialog/oauth?response_type=code&client_id=1802126316499818&redirect_uri=' + encodeURI(process.env.REACT_APP_REDIRECT_URL)}>
                  <span className='fa fa-facebook-official' /> Facebook</a>
              </Col>

              <Col sm={3}>
                <a href={'https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=7868w4a86yrezy&redirect_uri=' + encodeURI(process.env.REACT_APP_REDIRECT_URL) + '&state=987654321&scope=r_basicprofile%20r_emailaddress'}>
